...
- `Use correct abbreviations, from 18F <https://github.com/testthedocs/vale-styles/blob/master/18F/Abbreviations.yml>`_
...
- `British English quote and punctuation combination <https://github.com/testthedocs/vale-styles/blob/master/18F/Quotes.yml>`_
- `Negative language use, from MailChimp <https://github.com/testthedocs/vale-styles/blob/master/MailChimp/Negative.yml>`_
- `Using 'guys' <https://github.com/testthedocs/vale-styles/blob/master/Pedantic/Guys.yml>`_
- `List start with a capital letter, from OpenStack <https://github.com/testthedocs/vale-styles/blob/master/OpenStack/ListStart.yml>`_
...
- Overly complex text with `too Wordy from write-good <https://github.com/testthedocs/vale-styles/blob/master/write-good/TooWordy.yml>`_, `avoid from MailChimp <https://github.com/testthedocs/vale-styles/blob/master/MailChimp/Avoid.yml>`_, `terms from Pedantic <https://github.com/testthedocs/vale-styles/blob/master/Pedantic/Terms.yml>`_, and `complex from PlainLanguage <https://github.com/testthedocs/vale-styles/blob/master/PlainLanguage/ComplexWords.yml>`_
- Readability score
